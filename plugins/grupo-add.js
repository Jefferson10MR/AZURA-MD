...
await conn.reply(text+'@s.whatsapp.net', `Hola! me presento, soy 𝘼𝙕𝙐𝙍𝘼-𝙈𝘿 ✨, soy un Bot de WhatsApp, una persona del grupo utilizo el comando para añadirte al grupo, pero no pude agregarte, asi que te mando la invitacion para que te agregues, te esperamos!!\n\n${link}`, m, {mentions: [m.sender]})
